...
@property (nonatomic, strong) UMCGoodsModel *model;
@property (nonatomic, strong) NSArray *goodsKeys;
@property (nonatomic, strong) NSArray *goodsParamsKeys;

@end

@implementation UMCGoodsMessageTestViewController
...
- (void)appendGoodsParams {
    ...
    UMCGoodsParamModel *paramModel = [UMCGoodsParamModel new];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        UMCGoodsParamModel *paramModel = self.model.params[indexPath.section-1];
        if (indexPath.row == 0) {
