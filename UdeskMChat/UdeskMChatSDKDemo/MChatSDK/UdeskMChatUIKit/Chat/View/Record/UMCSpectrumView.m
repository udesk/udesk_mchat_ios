...
@implementation UMCSpectrumView
...
- (void)setup
{
    ...
    @try {
        ...
        self.itemColor = [UIColor umcColorWithHexString:@"#007AFF"];
        ...
        self.stopwatch = [[UMCTimerLabel alloc] initWithLabel:self.timeLabel];
