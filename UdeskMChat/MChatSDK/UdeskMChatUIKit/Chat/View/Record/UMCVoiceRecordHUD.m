...
@implementation UMCVoiceRecordHUD
...
- (void)setup {
    ...
    if (!_tooShortRecordImageView) {
        ...
        if ([preferredLang isEqualToString:@"zh-Hans-CN"]) {
            tooShortImage = [UIImage umcDefaultVoiceTooShortImageCN];
        }
        else {
        
            tooShortImage = [UIImage umcDefaultVoiceTooShortImageEN];
        }
