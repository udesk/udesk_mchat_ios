...
@interface UMCVoiceRecordHelper () <AVAudioRecorderDelegate> {
...
@implementation UMCVoiceRecordHelper

- (id)init {
    self = [super init];
    if (self) {
        self.maxRecordTime = kUMCVoiceRecorderTotalTime;
...
- (NSString *)getRecorderPath {
    ...
    NSString *indetAAC = [NSString stringWithFormat:@"%@.aac",[UMCHelper soleString]];
