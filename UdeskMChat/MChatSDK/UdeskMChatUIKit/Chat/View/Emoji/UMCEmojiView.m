...
@interface UMCEmojiView ()

@property (nonatomic, strong) NSArray      *emojis;

@end

@implementation UMCEmojiView

#pragma mark - Life cycle

- (void)setup {
    if (kUMCScreenWidth<375) {
    ...
    @try {
        ...
        // init emojis
        self.emojis = [NSArray arrayWithContentsOfFile:UMCBundlePath(@"UDEmojiList.plist")];
        ...
        [sendBtn setTitle:UMCLocalizedString(@"udesk_send") forState:UIControlStateNormal];
        sendBtn.frame = CGRectMake(kUMCScreenWidth-90, kUMCScreenWidth<375?150:166, 75, 38);;
        sendBtn.backgroundColor = kUMCRGBACOLOR(8, 125, 253, 1);
        kUMCViewRadius(sendBtn, 4);
        ...
        deleteButton.frame = CGRectMake(sendBtn.frame.origin.x-50, kUMCScreenWidth<375?153:169, 36, 33);
        deleteButton.titleLabel.font = [UIFont systemFontOfSize:12];
        UIImage *deleteImage = [UIImage umcDefaultDeleteImage];
        UIImage *deleteImageh = [UIImage umcDefaultDeleteHighlightedImage];
