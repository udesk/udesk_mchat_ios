...
#import "UdeskUMCVideoPlayerView.h"
#import "UMCVideoUtil.h"
#import "UIImage+UMC.h"

@interface UdeskUMCSmallVideoPreviewViewController ()<UdeskUMCVideoPlayerViewDelegate>

@property (nonatomic, strong) UdeskUMCVideoPlayerView *playerView;

@end

@implementation UdeskUMCSmallVideoPreviewViewController
...
- (void)setupUI {
    ...
    if (self.url.length >0) {
        ...
        imgView = [[UIImageView alloc] initWithImage:[UMCVideoUtil videoPreViewImageWithURL:self.url]];
        [self.view addSubview:imgView];
        imgView.frame = self.view.bounds;
        
        _playerView = [[UdeskUMCVideoPlayerView alloc] initWithFrame:self.view.bounds videoUrl:self.url];
    ...
    [confirmBtn setImage:[UIImage umcDefaultSmallVideoDone] forState:UIControlStateNormal];
    ...
    [backBtn setImage:[UIImage umcDefaultSmallVideoRetake] forState:UIControlStateNormal];
