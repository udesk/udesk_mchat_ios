...
typedef NS_ENUM(NSInteger, UMCRecorderFinishedReason){
...
typedef void (^UdeskFinishRecordingBlock)(NSDictionary *info, UMCRecorderFinishedReason finishReason);

@interface UMCSmallVideoManager : NSObject
