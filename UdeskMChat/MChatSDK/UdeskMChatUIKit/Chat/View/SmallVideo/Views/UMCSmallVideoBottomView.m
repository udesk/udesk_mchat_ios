...
#import "UdeskUMCSmallVideoRecordView.h"
#import "UMCBundleHelper.h"

@interface UMCSmallVideoBottomView()<UdeskUMCSmallVideoRecordViewDelegate>
...
@property (nonatomic, strong) UdeskUMCSmallVideoRecordView *recordView;

@end

@implementation UMCSmallVideoBottomView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        
        _recordView = [[UdeskUMCSmallVideoRecordView alloc] initWithFrame:CGRectMake(0, 0, 80, 80)];
        ...
        _tipLabel.text = UMCLocalizedString(@"udesk_small_video_tips");
...
- (void)smallVideoRecordView:(UdeskUMCSmallVideoRecordView *)recordView recordDuration:(CGFloat)recordDuration {
    ...
    _timeLabel.text = [NSString stringWithFormat:@"%.f%@ / %ld%@",recordDuration,UMCLocalizedString(@"udesk_second"),(long)_duration,UMCLocalizedString(@"udesk_second")];
}
