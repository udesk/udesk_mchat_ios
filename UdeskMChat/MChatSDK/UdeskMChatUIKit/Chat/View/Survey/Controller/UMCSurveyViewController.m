...
#import "UIViewController+UMC.h"
#import "UIView+UMC.h"
#import "UMCSurveyView.h"

@interface UMCSurveyViewController ()<UIApplicationDelegate, UIGestureRecognizerDelegate>

@end

@implementation UMCSurveyViewController
...
- (void)subscribeToKeyboard {
    ...
    [self udSubscribeKeyboardWithBeforeAnimations:nil animations:^(CGRect keyboardRect, NSTimeInterval duration, BOOL isShowing) {
        ...
        if (self.surveyView) {
            self.surveyView.surveyContentView.keyboardHeight = self.view.umcHeight-keyboardY;
            self.surveyView.umcBottom = keyboardY;
        }
