 ...
 */
@interface UMC_YYKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, UMC_YYKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    UMC_YYKVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    UMC_YYKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    UMC_YYKVStorageTypeMixed = 2,
};
 ...
 */
@interface UMC_YYKVStorage : NSObject
...
@property (nonatomic, readonly) UMC_YYKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(UMC_YYKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable UMC_YYKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable UMC_YYKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<UMC_YYKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<UMC_YYKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
