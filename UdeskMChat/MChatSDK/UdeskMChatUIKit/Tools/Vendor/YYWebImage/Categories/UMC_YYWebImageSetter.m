...
NSString *const UMC_YYWebImageFadeAnimationKey = @"YYWebImageFade";
const NSTimeInterval UMC_YYWebImageFadeTime = 0.2;
const NSTimeInterval UMC_YYWebImageProgressiveFadeTime = 0.4;


@implementation UMC_YYWebImageSetter {
...
- (int32_t)setOperationWithSentinel:(int32_t)sentinel
    ...
    if (sentinel != _sentinel) {
        if (completion) completion(nil, imageURL, UMC_YYWebImageFromNone, UMC_YYWebImageStageCancelled, nil);
        return _sentinel;
    }
    ...
    if (!operation && completion) {
        ...
        completion(nil, imageURL, UMC_YYWebImageFromNone, UMC_YYWebImageStageFinished, [NSError errorWithDomain:@"com.ibireme.webimage" code:-1 userInfo:userInfo]);
    }
