...
@interface UMC_UIImage_YYWebImage : NSObject @end
@implementation UMC_UIImage_YYWebImage @end
 ...
 */
static CGRect _UMCYYCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
...
@implementation UIImage (UMC_YYWebImage)
...
- (void)udesk_yy_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = _UMCYYCGRectFitWithContentMode(rect, self.size, contentMode);
