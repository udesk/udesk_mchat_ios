 ...
 */
@interface UIImageView (UMC_YYWebImage)
 ...
 */
- (void)udesk_yy_setImageWithURL:(nullable NSURL *)imageURL options:(UMC_YYWebImageOptions)options;
...
- (void)udesk_yy_setImageWithURL:(nullable NSURL *)imageURL
               placeholder:(nullable UIImage *)placeholder
                   options:(UMC_YYWebImageOptions)options
                   manager:(nullable UMC_YYWebImageManager *)manager
                  progress:(nullable UMC_YYWebImageProgressBlock)progress
                 transform:(nullable UMC_YYWebImageTransformBlock)transform
                completion:(nullable UMC_YYWebImageCompletionBlock)completion;
...
/**
 ...
 @param options  The options to use when request the image.
 */
- (void)udesk_yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL options:(UMC_YYWebImageOptions)options;
