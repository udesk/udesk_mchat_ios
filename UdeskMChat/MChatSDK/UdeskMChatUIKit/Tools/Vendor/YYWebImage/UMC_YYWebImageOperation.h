 ...
 */
@interface UMC_YYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) UMC_YYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   UMC_YYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(UMC_YYWebImageOptions)options
                          cache:(nullable UMC_YYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable UMC_YYWebImageProgressBlock)progress
                      transform:(nullable UMC_YYWebImageTransformBlock)transform
                     completion:(nullable UMC_YYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
