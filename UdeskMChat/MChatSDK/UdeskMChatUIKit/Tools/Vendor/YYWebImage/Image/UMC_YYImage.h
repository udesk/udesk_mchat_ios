...
#import "UMC_YYFrameImage.h"
#import "UMC_YYSpriteSheetImage.h"
 ...
 */
@interface UMC_YYImage : UIImage <UdeskYYAnimatedImage>

+ (nullable UMC_YYImage *)imageNamed:(NSString *)name; // no cache!
+ (nullable UMC_YYImage *)imageWithContentsOfFile:(NSString *)path;
+ (nullable UMC_YYImage *)imageWithData:(NSData *)data;
+ (nullable UMC_YYImage *)imageWithData:(NSData *)data scale:(CGFloat)scale;

/**
 If the image is created from data or file, then the value indicates the data type.
 */
@property (nonatomic, readonly) UMC_YYImageType animatedImageType;
