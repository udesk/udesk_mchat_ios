...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, UMC_YYImageType) {
    UMC_YYImageTypeUnknown = 0, ///< unknown
    UMC_YYImageTypeJPEG,        ///< jpeg, jpg
    UMC_YYImageTypeJPEG2000,    ///< jp2
    UMC_YYImageTypeTIFF,        ///< tiff, tif
    UMC_YYImageTypeBMP,         ///< bmp
    UMC_YYImageTypeICO,         ///< ico
    UMC_YYImageTypeICNS,        ///< icns
    UMC_YYImageTypeGIF,         ///< gif
    UMC_YYImageTypePNG,         ///< png
    UMC_YYImageTypeWebP,        ///< webp
    UMC_YYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, UMC_YYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    UMC_YYImageBlendNone = 0,
    
    /**
     The frame should be composited onto the output buffer based on its alpha.
     */
    UMC_YYImageBlendOver,
};

/**
 An image frame object.
 */
@interface UMC_YYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) UMC_YYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) UMC_YYImageBlendOperation blend;      ///< Frame blend operation.
 ...
 */
@interface UMC_YYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) UMC_YYImageType type;          ///< Image data type.
 ...
 */
- (nullable UMC_YYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
 ...
 */
@interface UMC_YYImageEncoder : NSObject

@property (nonatomic, readonly) UMC_YYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(UMC_YYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(UMC_YYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(UMC_YYImageDecoder *)decoder type:(UMC_YYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (UMC_YYImageCoder)
...
CG_EXTERN UMC_YYImageType UMC_YYImageDetectType(CFDataRef data);

/// Convert YYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable UMC_YYImageTypeToUTType(UMC_YYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to YYImageType.
CG_EXTERN UMC_YYImageType UMC_YYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable UMC_YYImageTypeGetExtension(UMC_YYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef UMC_YYCGColorSpaceGetDeviceRGB(void);

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef UMC_YYCGColorSpaceGetDeviceGray(void);

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL UMC_YYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL UMC_YYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation UMC_YYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger UMC_YYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable UMC_YYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable UMC_YYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable UMC_YYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable UMC_YYCGImageCreateEncodedData(CGImageRef imageRef, UMC_YYImageType type, CGFloat quality);


/**
 Whether WebP is available in YYImage.
 */
CG_EXTERN BOOL UMC_YYImageWebPAvailable(void);
 ...
 */
CG_EXTERN NSUInteger UMC_YYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable UMC_YYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, UMC_YYImagePreset) {
    UMC_YYImagePresetDefault = 0,  ///< default preset.
    UMC_YYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    UMC_YYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    UMC_YYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    UMC_YYImagePresetIcon,         ///< small-sized colorful images
    UMC_YYImagePresetText          ///< text-like
};
 ...
 */
CG_EXTERN CFDataRef _Nullable UMC_YYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             UMC_YYImagePreset preset);
