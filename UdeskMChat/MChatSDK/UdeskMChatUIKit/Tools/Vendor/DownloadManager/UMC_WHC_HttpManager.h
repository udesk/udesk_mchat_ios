...
#import "UMC_WHC_DownloadOperation.h"

/**
 * 默认下载并发数量 在里面修改
 */

extern const NSInteger kUMCWHCDefaultDownloadNumber;

/**
 * 说明: WHC_HttpManager http请求管理类 (单例设计模式 支持POST/GET 请求 文件上传 文件下载)
 */

@interface UMC_WHC_HttpManager : NSObject
...
- (nullable UMC_WHC_DownloadOperation *)replaceCurrentDownloadOperationBlockResponse:(nullable UMC_WHCResponse)responseBlock
                                             process:(nullable UMC_WHCProgress)processBlock
...
- (nullable UMC_WHC_DownloadOperation *)replaceCurrentDownloadOperationDelegate:(nullable id<UMC_WHC_DownloadDelegate>)delegate
                                       fileName:(nonnull NSString *)fileName;
 ...
 * @param didFinishedBlock 下载完成回调
 */
- (nullable UMC_WHC_DownloadOperation *)replaceAllDownloadOperationBlockResponse:(nullable UMC_WHCResponse)responseBlock
                                         process:(nullable UMC_WHCProgress)processBlock
                                     didFinished:(nullable UMC_WHCDidFinished)didFinishedBlock;
...
- (nullable UMC_WHC_DownloadOperation *)replaceAllDownloadOperationDelegate:(nullable id<UMC_WHC_DownloadDelegate>)delegate;

/**
 * 说明：通过要下载的文件名来判断当前是否在进行下载任务
 * @param strUrl 正在下载的文件名
 */
